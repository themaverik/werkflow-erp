...
VALUES
    (1, 2025, '2025-01-01', '2025-12-31', 150000.00, 120000.00,  8500.00, 'ACTIVE',  1, 6, '2025-01-15 09:00:00', 'IT FY2025 — covers hardware refresh, software licenses, cloud infra.',         'default'),
    (2, 2025, '2025-01-01', '2025-12-31',  80000.00,  60000.00,  1500.00, 'ACTIVE',  4, 6, '2025-01-15 09:00:00', 'HR FY2025 — recruitment, training programs, employee engagement events.',     'default'),
    (3, 2025, '2025-01-01', '2025-12-31', 120000.00,  95000.00,  4200.00, 'ACTIVE',  6, 6, '2025-01-15 09:00:00', 'Finance FY2025 — audit fees, software, compliance training.',                'default'),
    (4, 2025, '2025-01-01', '2025-12-31', 100000.00,  75000.00,  3600.00, 'ACTIVE',  9, 6, '2025-01-15 09:00:00', 'Procurement FY2025 — vendor onboarding, travel, system subscriptions.',     'default'),
    (7, 2025, '2025-01-01', '2025-12-31',  90000.00,  70000.00,  2800.00, 'ACTIVE', 11, 6, '2025-01-15 09:00:00', 'Logistics FY2025 — fleet maintenance, warehouse ops, freight expenses.',    'default');
...
VALUES
    -- IT plan (id=1)
    (1, 7, 'Hardware refresh — laptops and peripherals', 60000.00, 5998.00, 'default'),
    (1, 9, 'Software licenses — JetBrains, Atlassian, GitHub', 30000.00, 2400.00, 'default'),
    (1, 4, 'Cloud infrastructure — AWS, monitoring tools',    30000.00,  102.00, 'default'),

    -- HR plan (id=2)
    (2, 3, 'Recruitment — job boards, assessments',           20000.00,    0.00, 'default'),
    (2, 8, 'Employee training and development programs',      25000.00, 1500.00, 'default'),
    (2, 5, 'Office supplies and onboarding kits',             15000.00,    0.00, 'default'),

    -- Finance plan (id=3)
    (3, 9, 'Accounting software — SAP, QuickBooks',          35000.00, 3200.00, 'default'),
    (3, 6, 'Finance team travel and audit visits',            20000.00, 1000.00, 'default'),
    (3, 8, 'Compliance and CFA training',                     40000.00,    0.00, 'default'),

    -- Procurement plan (id=4)
    (4, 9, 'Procurement platform — Ariba subscription',      40000.00, 3600.00, 'default'),
    (4, 6, 'Vendor visits and supplier audits travel',        20000.00,    0.00, 'default'),
    (4, 5, 'Office supplies and documentation',               15000.00,    0.00, 'default'),

    -- Logistics plan (id=5)
    (5, 2, 'Fleet maintenance and vehicle servicing',         40000.00, 2800.00, 'default'),
    (5, 1, 'Warehouse operations and freight costs',          20000.00,    0.00, 'default'),
    (5, 5, 'Packing materials and labelling supplies',        10000.00,    0.00, 'default');
