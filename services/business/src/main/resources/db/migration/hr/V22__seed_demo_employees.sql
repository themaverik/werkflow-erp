...
VALUES ('Logistics', 'LOGISTICS', 1, 'OPS', 'SHILLONG_IN', 'logistics@werkflow.com', true, 'default');
...
VALUES
    (2, 'ANNUAL',  '2025-04-07', '2025-04-11', 5, 'Family vacation', 'APPROVED', 1, '2025-03-28', 'default'),
    (5, 'SICK',    '2025-03-17', '2025-03-18', 2, 'Fever and cold',  'APPROVED', 4, '2025-03-17', 'default');
...
VALUES
    (1, 4, 2025, '2025-04-30', 8500.00,  500.00,  0.00, 1500.00, 200.00,  9000.00,  7300.00, true,  'default'),
    (4, 4, 2025, '2025-04-30', 7500.00,  400.00,  0.00, 1200.00, 150.00,  7900.00,  6550.00, true,  'default'),
    (6, 4, 2025, '2025-04-30',12000.00, 1000.00, 500.00,2500.00, 300.00, 13500.00, 10700.00, true,  'default');
