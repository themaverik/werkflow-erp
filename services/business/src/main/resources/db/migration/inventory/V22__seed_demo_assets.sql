...
VALUES
    (1, 'ASSET-IT-0001', 'C02ZK1ABMD6N', '2025-03-08', 2999.00, '2027-03-08', 'NEW',  'IN_USE',    'Seattle HQ — IT Floor',    'default-tenant'),
    (1, 'ASSET-IT-0002', 'C02ZK1ACMD6N', '2025-03-08', 2999.00, '2027-03-08', 'NEW',  'IN_USE',    'Seattle HQ — IT Floor',    'default-tenant'),
    (2, 'ASSET-IT-0003', 'DXPS15SN00312','2024-08-15', 1899.00, '2026-08-15', 'GOOD', 'AVAILABLE', 'Seattle HQ — IT Stockroom','default-tenant'),
    (4, 'ASSET-IT-0004', 'G7TXR4K5PHN8M','2024-11-01',  999.00, '2025-11-01', 'GOOD', 'IN_USE',    'Seattle HQ — IT Floor',    'default-tenant'),
    (9, 'ASSET-OFF-0001','HM-AERON-00045','2023-06-20', 1395.00, '2033-06-20', 'GOOD', 'IN_USE',    'Bangalore HQ — HR Floor',  'default-tenant');
...
VALUES
    ...
    (1, 1, 2, 'Seattle HQ — IT Floor, Desk S-104', 'PERMANENT', '2025-03-10 09:00:00', NULL, 'default-tenant'),
    -- MacBook #2 → Mike Torres (EMP-003, IT dept)
    (2, 1, 3, 'Seattle HQ — IT Floor, Desk S-106', 'PERMANENT', '2025-03-10 09:00:00', NULL, 'default-tenant'),
    -- iPhone → James Chen (EMP-001, IT Manager)
    (4, 1, 1, 'Seattle HQ — IT Floor, Desk S-101', 'PERMANENT', '2024-11-05 10:00:00', NULL, 'default-tenant'),
    -- Ergonomic Chair → Priya Sharma (EMP-004, HR)
    (5, 2, 4, 'Bangalore HQ — HR Floor, Desk B-201', 'PERMANENT', '2023-06-25 08:30:00', NULL, 'default-tenant');
...
VALUES
    (3, 1, 1, 4, 9,
     ...
     1, '2025-04-20 11:00:00', 'PENDING', 'default-tenant');
